...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'train.modeTitle': 'Show railways and identify the line you are on',
      'train.modeOn': 'train on',
      'train.modeOff': 'train off',
      'train.mode': 'Train mode',
      'train.on': 'On',
      'train.off': 'Off',
      'train.searching': "Looking for the track you're on…",
      'train.noTrack': 'No railway found under you. This works while you are actually on a line.',
      'train.lookupFailed': 'Could not reach the railway database. Check your connection.',
      ...
      'train.noStops': "No stations ahead yet — this needs you to be moving before it can tell which way you're going.",
      'train.disclaimer': "Estimated from OpenStreetMap's railway data and your own speed and heading — not a timetable lookup, so it names the line and the kind of service, never a specific train number.",
    ...
    de: {
      ...
      'train.modeTitle': 'Bahnstrecken anzeigen und die Strecke erkennen, auf der du fährst',
      'train.modeOn': 'Zug an',
      'train.modeOff': 'Zug aus',
      'train.mode': 'Zugmodus',
      'train.on': 'An',
      'train.off': 'Aus',
      'train.searching': 'Suche das Gleis, auf dem du bist…',
      'train.noTrack': 'Keine Bahnstrecke unter dir gefunden. Das funktioniert, während du tatsächlich auf einer Strecke bist.',
      'train.lookupFailed': 'Die Bahndatenbank ist nicht erreichbar. Prüfe deine Verbindung.',
      ...
      'train.noStops': 'Noch keine Halte voraus — dafür musst du in Bewegung sein, damit die Fahrtrichtung erkennbar ist.',
      'train.disclaimer': 'Geschätzt anhand der Bahndaten von OpenStreetMap sowie deiner Geschwindigkeit und Richtung — keine Fahrplanabfrage. Daher werden Strecke und Zugart genannt, nie eine konkrete Zugnummer.',
    ...
    pl: {
      ...
      'train.modeTitle': 'Pokaż linie kolejowe i rozpoznaj trasę, którą jedziesz',
      'train.modeOn': 'pociąg wł.',
      'train.modeOff': 'pociąg wył.',
      'train.mode': 'Tryb pociągu',
      'train.on': 'Wł.',
      'train.off': 'Wył.',
      'train.searching': 'Szukam toru, na którym jesteś…',
      'train.noTrack': 'Nie znaleziono linii kolejowej pod tobą. To działa, gdy faktycznie jesteś na trasie.',
      'train.lookupFailed': 'Nie można połączyć się z bazą danych kolejowych. Sprawdź połączenie.',
      ...
      'train.noStops': 'Brak przystanków przed tobą — musisz być w ruchu, aby dało się określić kierunek jazdy.',
      'train.disclaimer': 'Oszacowane na podstawie danych kolejowych OpenStreetMap oraz twojej prędkości i kierunku — to nie jest odczyt rozkładu jazdy, więc podaje linię i rodzaj pociągu, nigdy konkretny numer pociągu.',
